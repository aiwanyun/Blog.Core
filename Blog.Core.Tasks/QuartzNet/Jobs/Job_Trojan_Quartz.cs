...
namespace Blog.Core.Tasks
{
    public class Job_Trojan_Quartz : JobBase, IJob
    {
        ...
        public Job_Trojan_Quartz(IUnitOfWorkManage unitOfWorkManage, IBaseServices<TrojanDetails> iusers_DetailServices, ITrojanUsersServices trojanUsers, ITasksQzServices tasksQzServices, ITasksLogServices tasksLogServices)
